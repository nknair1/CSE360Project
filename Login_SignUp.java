...
public class Login_SignUp extends Application  {
	...
	textfields.getChildren().addAll(email, emailTextField, 
	password, passwordTextField,forgot,login, create);
	...
	titleBox.setStyle("-fx-background-color: #ffd700;");
	titleBox.setMinHeight(120);
//	titleBox.s/etAlignment(Pos.TOP_CENTER)
...
//	HBox titleBox = new HBox();
	...
	TextField passwordTextField2 = new TextField();
        ...
        public void handle(ActionEvent event) {
            ...
            if (loggedInUser != null) {
                ...
                if (loggedInUser.getUserType().equalsIgnoreCase("Buyer")) {
                    ...
                    showAlert("Login successful", "Seller view is under construction.");
                }
            } else {
